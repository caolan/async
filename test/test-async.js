...
exports['cargoDelayed'] = function (test) {
    var delay = 2000;
    var offset = 500;

    var c = async.cargoDelayed(function (tasks, callback) {
      callback();
    }, 3, delay);
...
exports['cargoDelayed without payload'] = function (test) {
    var delay = 2000;
    var offset = 500;
